...
export function clearScreen()
{
	...
	if (!globals.antialias) {
		globals.canvas.style.imageRendering = 'crisp-edges';
...
/**
 * Retorna el rectangulo de intersección (si existe) entre los rectangulos datos.
 * @param {Rect} rect0
 * @param {Rect} rect1
 * @returns {Rect}
 */
export function getIntersection (rect0, rect1)
{
	let Ax1 = rect0.x;
	let Ay1 = rect0.y;
	let Ax2 = rect0.x + rect0.width-1;
